...
#define DATA_FILE "data/pset-hash-10k-cxptm.txt"
...
int main(void) {
    ...
    const int numElements = 10*1000;                                 // Number of keys in the set
...
#ifdef USE_PMDK
    std::cout << "If you use PMDK in /dev/shm/, don't forget to set 'export PMEM_IS_PMEM_FORCE=1'\n";
#endif
