...
plot \
    '../data/castor/db-rocksdb-10m.txt'       using 1:($1/$4)  with linespoints notitle ls 11 lw 4 dt (1,1), \
    '../data/castor/db-redotimedhash-10m.txt' using 1:($1/$4)  with linespoints notitle ls 9  lw 4 dt 1
...
plot \
    '../data/castor/db-rocksdb-10m.txt'       using 1:($1/$5)  with linespoints notitle ls 11 lw 4 dt (1,1), \
    '../data/castor/db-redotimedhash-10m.txt' using 1:($1/$5)  with linespoints notitle ls 9  lw 4 dt 1
...
plot \
    '../data/castor/db-rocksdb-10m.txt'       using 1:($1/$3)  with linespoints notitle ls 11 lw 4 dt (1,1), \
    '../data/castor/db-redotimedhash-10m.txt' using 1:($1/$3)  with linespoints notitle ls 9  lw 4 dt 1
